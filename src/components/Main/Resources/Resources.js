   ...
   <div className="tab-content links mx-auto" id="v-pills-tabContent">
      <div className="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
        <ul>
          ...
          <li key={resource._id}>{resource.name}<br/><a rel="noopener noreferrer" href={`https://ieeemock2.azurewebsites.net/upload/pdf/resource/${resource.pdfPath}`} target="_blank">Conference papers</a><br/><br/></li>
          )}
        </ul>
      </div>
